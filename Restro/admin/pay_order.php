                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                            <a href="pay_order.php?order_code=<?php echo htmlspecialchars($order->order_code); ?>&customer_id=<?php echo htmlspecialchars($order->customer_id); ?>&order_status=Paid">

                                                    <button class="btn btn-sm btn-success">
                                                        <i class="fas fa-handshake"></i> Pay Order
                                                    </button>
                                                </a>
                                                <a href="payments.php?cancel=<?php echo urlencode($order->order_id); ?>">
